...
#############################
        if [[ ! -e "C:\Program Files\boost_$BOOST_VERSION" ]]; then
            ...
            cmd //c .\\bootstrap.bat
            cmd //c .\\b2.exe --toolset=msvc-12.0 address-model=64 --prefix="$BOOST_ROOT" --build-type=complete install
            cd ..
        fi
...
##      Build Collada      ##
#############################
        boost_include_prefix=$BOOST_ROOT/include/boost-$BOOST_MAJOR_VERSION
        ...
        if [[ ! -e "C:\Program Files\collada-dom" || $FORCE -eq 1 ]]; then
            ...
            CMAKE_ARGS="-DBOOST_ROOT:PATH=\"$boost_include_prefix\" "
            CMAKE_ARGS+="-DBOOST_LIBRARYDIR:PATH=\"$BOOST_ROOT/lib\" "
