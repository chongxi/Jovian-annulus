...
class Communicator
{
  public:
    ...
    Communicator( std::string host = "localhost", std::string port = "22222", int retries = 2 ): 
       success( false ), reply_length( 0 ) {}
     ...
     */
    virtual void read( bool handshake = true ) = 0;
