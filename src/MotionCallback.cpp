...
CameraMotionUpdateCallback::CameraMotionUpdateCallback( btRigidBody* body,
    ...
    _vel_frame_index( 0 ), _interval_for_vel_smoothing( 32 ), _interval_for_segment_smoothing( 32 ),
    ...
    _input_ratio( 2 ), _output_angle( 2 ), _intermediary_smoothing_val( 0.f ), _segment_rate_val(0.f),
...
void
CameraMotionUpdateCallback::interval_for_heading_smoothing( int segment_interval,
                                                            int input_interval,
                                                            int intermediary_interval,
                                                            int output_interval )
{
    _interval_for_segment_smoothing = ( segment_interval >= 0 ? segment_interval : _interval_for_segment_smoothing );
    ...
    compute_frame_buffer_size( _frame_rate, _interval_for_segment_smoothing, &_segment_rate, &_segment_rate_val,  0.f );
