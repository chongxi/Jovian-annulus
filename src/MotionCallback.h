...
class CameraMotionUpdateCallback : public osg::NodeCallback
{
  public:
    ...
    virtual void set_average_framerate( float rate ) { _frame_rate = rate; interval_for_velocity_smoothing( _interval_for_vel_smoothing ); interval_for_heading_smoothing( _interval_for_segment_smoothing, _interval_for_input_smoothing, _interval_for_intermediary_smoothing, _interval_for_output_smoothing ); }
    ...
    void enable_segment_heading_smoothing( bool on_or_off ) { _use_segment_heading_smoothing = on_or_off; _segment_rate.clear(); _segment_rate_val = 0.f;}
    ...
    void interval_for_heading_smoothing( int segment_interval,
                                         int input_interval,
                                         int intermediary_interval,
                                         int output_interval );
    void set_plot_data( Graph_Evaluator vals, Graph_Evaluator vels ) { _plot = vals; _v_plot = vels; }
    virtual void enable_threshold_turning( bool yes_or_no ) { _enable_turning = yes_or_no; }
  ...
  protected:
    ...
    bool      _use_segment_heading_smoothing, _use_intermediary_heading_smoothing;
    bool      _use_output_heading_smoothing;
    int        _vel_frame_index, _head_frame_index, _interval_for_vel_smoothing, _interval_for_segment_smoothing, _interval_for_input_smoothing, _interval_for_intermediary_smoothing, _interval_for_output_smoothing;
    ...
    boost::circular_buffer< float > _segment_rate;
    float _segment_rate_val;
